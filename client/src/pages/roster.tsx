import { ChevronRight, Unlink, UsersRound } from 'lucide-react';
              ...
              >
                <div className="flex items-center gap-4">
                  <Link
                    ...
                    data-testid={`link-athlete-detail-${athlete.linkId}`}
                    className="flex min-w-0 flex-1 items-center gap-4 rounded-xl -m-1 p-1 hover:bg-[hsl(var(--muted))]"
                  >
